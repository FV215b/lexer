...
STRING | COMMENT | CONTROL | DOUBLE_ESCAPE | ESCAPE | INITIAL
...
fun yyAction44 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN STRING; currentString :=""; stringStartPos := yypos; continue()))
fun yyAction45 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN ESCAPE; continue()))
fun yyAction46 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN INITIAL; Tokens.STRING(!currentString, !stringStartPos, yypos + 1)))
...
fun yyAction48 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (appendS yytext; continue())
      end
...
fun yyAction59 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (ErrorMsg.error yypos ("illegal double escape character " ^ yytext); continue())
      end
fun yyAction60 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm;
        (controlToString (yytext,yypos); YYBEGIN STRING; continue ())
      end
       ...
       of NONE => yyAction66(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ68(strm', yyMATCH(strm, yyAction66, yyNO_MATCH))
            else if inp < #"h"
              then if inp = #"`"
                  then yyAction66(strm, yyNO_MATCH)
                  else yyQ67(strm', yyMATCH(strm, yyAction66, yyNO_MATCH))
       ...
       of NONE => yyAction66(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction66(strm, yyNO_MATCH)
                  else yyQ72(strm', yyMATCH(strm, yyAction66, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ67(strm', yyMATCH(strm, yyAction66, yyNO_MATCH))
              else yyAction66(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"a"
              ...
              then if inp = #"i"
                  ...
                  then if inp = #"h"
                      then yyQ74(strm', yyMATCH(strm, yyAction66, yyNO_MATCH))
                      else yyQ67(strm', yyMATCH(strm, yyAction66, yyNO_MATCH))
                else if inp = #"o"
                  then yyQ75(strm', yyMATCH(strm, yyAction66, yyNO_MATCH))
                  else yyQ67(strm', yyMATCH(strm, yyAction66, yyNO_MATCH))
            else if inp = #"z"
              then yyQ67(strm', yyMATCH(strm, yyAction66, yyNO_MATCH))
            else if inp < #"z"
              then if inp = #"y"
                  then yyQ76(strm', yyMATCH(strm, yyAction66, yyNO_MATCH))
                  else yyQ67(strm', yyMATCH(strm, yyAction66, yyNO_MATCH))
              else yyAction66(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction66(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"`"
              ...
              then yyQ98(strm', yyMATCH(strm, yyAction66, yyNO_MATCH))
            else if inp < #"n"
              then if inp = #"l"
                  then yyQ97(strm', yyMATCH(strm, yyAction66, yyNO_MATCH))
                  else yyQ67(strm', yyMATCH(strm, yyAction66, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ67(strm', yyMATCH(strm, yyAction66, yyNO_MATCH))
              else yyAction66(strm, yyNO_MATCH)
       ...
       of NONE => yyAction66(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ102(strm', yyMATCH(strm, yyAction66, yyNO_MATCH))
            else if inp < #"o"
              then if inp = #"`"
                  then yyAction66(strm, yyNO_MATCH)
                  else yyQ67(strm', yyMATCH(strm, yyAction66, yyNO_MATCH))
       ...
       of NONE => yyAction66(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ103(strm', yyMATCH(strm, yyAction66, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction66(strm, yyNO_MATCH)
                  else yyQ67(strm', yyMATCH(strm, yyAction66, yyNO_MATCH))
...
fun yyQ107 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction43(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"r"
              then yyQ108(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
              else yyAction43(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction66(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ107(strm', yyMATCH(strm, yyAction66, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction66(strm, yyNO_MATCH)
                  else yyQ67(strm', yyMATCH(strm, yyAction66, yyNO_MATCH))
...
fun yyQ48 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction23(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ111(strm', yyMATCH(strm, yyAction23, yyNO_MATCH))
       ...
       of NONE => yyAction25(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              ...
              then if inp = #"="
                  then yyQ112(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
...
fun yyQ13 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ14(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
...
fun yyQ12 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"/"
              then yyQ15(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
              else yyAction65(strm, yyNO_MATCH)
      (* end case *))
...
in
  (case (!(yyss))
   of STRING => yyQ0(!(yystrm), yyNO_MATCH)
    ...
    | CONTROL => yyQ2(!(yystrm), yyNO_MATCH)
    | DOUBLE_ESCAPE => yyQ3(!(yystrm), yyNO_MATCH)
    | ESCAPE => yyQ4(!(yystrm), yyNO_MATCH)
